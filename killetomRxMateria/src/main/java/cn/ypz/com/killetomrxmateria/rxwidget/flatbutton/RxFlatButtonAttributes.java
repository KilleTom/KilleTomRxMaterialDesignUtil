...
public class RxFlatButtonAttributes {
    ...
    public RxFlatButtonAttributes(AttributeChangeListener attributeChangeListener, Resources resources) {
    ...
    public boolean hasTouchEffect() {
        return this.touchEffect != RxFlatButtonAttributes.DEFAULT_TOUCH_EFFECT;
    }
